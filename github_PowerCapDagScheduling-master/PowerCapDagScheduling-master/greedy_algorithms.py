...
def select_configuration(current_level, current_time, node_to_application, rand_wl_scale, applications, pace_tasks, power_cap):
...
def  get_tasks_per_power(ready_nodes, node_to_application, rand_wl_scale, applications, pace_tasks, power_cap, z):
    ...
    ignored_schedule, configurations = select_configuration(ready_nodes[:count], 0, node_to_application, rand_wl_scale, applications, pace_tasks, power_cap)
...
def naive_grab_all_run_all(num_machines, number_of_nodes_in_dag, dag_adj_list_by_index, node_to_application, rand_wl_scale, applications, power_cap):
    ...
    while num_completed_tasks < number_of_nodes_in_dag:
        ...
        if z>0:
            configurations_of_ready_nodes, no_of_current_sched_nodes = get_tasks_per_power(ready_nodes, node_to_application, rand_wl_scale, applications, pace_tasks, power_cap, z)
