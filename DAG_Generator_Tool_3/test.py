    ...
    def Core_act(self, environment, core_ID):
        ...
        while self.Dag_Set.get_node_num() > 0:
            with self.core_Set.request() as request:
                ...
                self.Dag_Set.delet_DAG_Node(DAG_ID, ready_high_node[0])
                self.Dag_Set.Status_Dataup()
                # step5.打印，core_ID;
