...
class Core:
    ...
    def __init__(self, Core_ID):
        ...
        # (DAG_ID, Task_num, Start_Time, WCET, Finish_Time, Task_ID)
...
if __name__ == "__main__":
    ...
    core.Insert_Task(DAG_ID=1, Task_ID=1, Star_Time=100, WCET=34556, Task_name='1')
    core.Insert_Task(DAG_ID=1, Task_ID=2, Star_Time=100, WCET=34556, Task_name='2')
    core.Insert_Task(DAG_ID=1, Task_ID=3, Star_Time=100, WCET=34556, Task_name='3')
    core.Show_Core()
